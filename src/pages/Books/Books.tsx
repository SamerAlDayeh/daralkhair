...
export const Books: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState<'featured' | 'price-desc' | 'price-asc' | 'newest' | 'oldest' | 'rating'>('featured');
  ...
  const filteredBooks = useMemo(() => {
    return BOOKS_DATA.filter(book => {
      ...
      const matchesCategory =
        selectedCategory === 'جميع التصنيفات' || book.category === selectedCategory;
      ...
      <section className="books-hero">
        ...
        <div className="container">
          <div className="books-hero-content font-arabic">
            <span className="section-subtitle">المطبوعات والتحقيقات الشرعية</span>
            <h1 className="books-hero-title">المكتبة الشاملة والفهرس العام</h1>
            <p className="books-hero-desc">
              استعرض وبحث في مجموعات دار الخير الشاملة لأمهات كتب التفسير، الحديث الشريف، الفقه، والتاريخ الإسلامي المحققة.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="catalog-layout">
            ...
            <aside className="filters-sidebar font-arabic">
              <div className="sidebar-header">
                ...
                <button onClick={resetFilters} className="reset-btn" title="إعادة تعيين الفلاتر">
                  <RefreshCw size={14} />
                  <span>إعادة ضبط</span>
                </button>
              </div>
            ...
            <main className="catalog-main">
              ...
              <div className="catalog-toolbar font-arabic">
                <div className="results-count">
                  عرض <strong>{filteredBooks.length}</strong> من إجمالي <strong>{BOOKS_DATA.length}</strong> مطبوعة
                </div>
              ...
              {filteredBooks.length > 0 ? (
                ...
                <div className="no-results-card font-arabic">
                  ...
                  <p>يرجى تغيير كلمات البحث، أو تصفير فلاتر الأقسام والأسعار.</p>
                  <button onClick={resetFilters} className="btn-gold mt-3 font-arabic">
