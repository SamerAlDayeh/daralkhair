...
export const IslamicPattern: React.FC<PatternProps> = ({ opacity = 0.05, className = '' }) => {
  return (
      ...
      <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="islamic-star-pattern" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <path d="M 0,0 L 60,60 M 60,0 L 0,60" stroke="currentColor" strokeWidth="0.3" strokeDasharray="2,2" />
          </pattern>
        </defs>
