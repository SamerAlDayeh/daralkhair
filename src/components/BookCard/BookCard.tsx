    ...
    <div className="book-card-wrapper">
      <div className="book-card">
        ...
        <div className="book-cover-container">
          ...
          <div className="book-badges">
            {book.isOffer && book.discountPercent && (
              <span className="badge discount-badge">خصم {book.discountPercent}%</span>
            )}
        ...
        <div className="book-info">
          ...
          <div className="book-author font-arabic">بقلم: {book.authorArabic || book.author}</div>
          ...
          <div className="book-card-footer">
            ...
            <Link to={`/books/${book.id}`} className="view-details-link font-arabic">
              التفاصيل ←
            </Link>
          </div>
        </div>
